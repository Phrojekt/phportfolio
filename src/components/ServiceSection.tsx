    ...
    const ServiceSection: React.FC = () => (
        <section className="bg-[#f5f5f5] text-black py-16 relative" id="services">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 px-6 md:px-0 z-10 relative">
                {/* UX/UI Design Card */}
                <div className="bg-black text-white p-12 flex flex-col items-center text-center rounded-lg shadow-lg">
                    <div className="mb-8">
                    ...
                    <h3 className="text-2xl font-medium mb-4">UX/UI Design</h3>
                ...
                <div className="bg-black text-white p-12 flex flex-col items-center text-center rounded-lg shadow-lg">
                    ...
                    <h3 className="text-2xl font-medium mb-4">Desenvolvimento Frontend</h3>
                    <p className="text-base leading-relaxed text-gray-300">
                ...
                <div className="bg-black text-white p-12 flex flex-col items-center text-center rounded-lg shadow-lg">
                    ...
                    <h3 className="text-2xl font-medium mb-4">Desenvolvimento Fullstack</h3>
                    <p className="text-base leading-relaxed text-gray-300">
